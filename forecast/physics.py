...
def _constant_velocity_heading_from_kinematics(kinematics_data: KinematicsData,
    ...
    :param sampled_at: Number of output to make per second.
    """
...
class ConstantVelocityHeading(Baseline):
    """ Makes output according to constant velocity and heading model. """
...
class PhysicsOracle(Baseline):
    """ Makes several physics-based output and picks the one closest to the ground truth. """
